		    ...
		    edu: [
		    	{
		    		...
		    		diploma: "Bachelor  of Science in Electrical Engineering",
		    		attendanceTime: "2006-2010",
		    		module: "Faculty of Electrical Engineering, Computer Science",
		...
		return(			
				<div className="moreInfoDiv">
				   ...
				   {this.state.exp.map(e => 
				    	 <section className="sectionCss" key={e.expId}>
				    	 <div className="imgDiv">
				    	 	<img  className="compImg" src={e.photo} alt="company"/>
				    	 </div>
				    ...
				    <div className="eduDivEl">
				    	...
				    	{this.state.edu.map(e =>   
				    	 	<section className="sectionCss" key={e.eduId}>
				    	 	<div className="imgDiv">
				    	 		<img  className="compImg" src={e.photo} alt="Institution"/>
				    	 	</div>
				    	 	<div className="eduInfoDiv">
